...
## Phase 33: スマホ対応（タッチ操作）
- [ ] 33.1 タッチイベントの実装（タップ、ドラッグ、ピンチ）
- [ ] 33.2 サイドバーのスワイプ操作対応
- [ ] 33.3 注釈のタッチ移動・リサイズ対応
- [ ] 33.4 ピンチズーム対応
- [ ] 33.5 モバイルUIの最適化（ボタンサイズ、タッチターゲット）

## Phase 34: CMYK変換・印刷用出力
- [ ] 34.1 CMYK変換ライブラリの調査・選定
- [ ] 34.2 RGB→CMYK変換処理の実装
- [ ] 34.3 CMYKプレビュー機能
- [ ] 34.4 CMYK PDF出力機能

## Phase 35: Canva機能調査・実装 (Future)
- [ ] 35.1 Canvaのオススメ機能調査・分析
    - [ ] テンプレート機能
    - [ ] 図形描画機能
    - [ ] テキストスタイル（フォント選択、装飾）
    - [ ] レイヤー管理
...
## Phase 36: スライド部分選択・コピー機能
- [ ] 36.1 範囲選択ツールの実装（矩形選択）
- [ ] 36.2 選択範囲のコピー機能（Ctrl+C）
- [ ] 36.3 選択範囲のペースト機能（同一スライド・別スライド）
- [ ] 36.4 選択範囲のカット機能（Ctrl+X）
- [ ] 36.5 Undo/Redo対応

## Phase 37: 名刺作成・印刷用PDF機能
- [ ] 37.1 名刺サイズテンプレート（91mm x 55mm）
- [ ] 37.2 塗り足し（裁ち落とし）設定（3mm）
- [ ] 37.3 トリムマーク（トンボ）描画機能
- [ ] 37.4 PDFフラット化オプション
- [ ] 37.5 印刷用PDF出力UIの実装

## Phase 38: PWA対応
- [ ] 38.1 Service Workerの設定
- [ ] 38.2 マニフェストファイルの作成
